...
public class MARWorldMapController : MonoBehaviour
{
    ...
    void SaveAndDisposeWorldMap(ARWorldMap worldMap)
    {
        ...
        Log(string.Format("> ARWorldMap has {0} KB.", data.Length/1024));
        ...
        data.Dispose();
        worldMap.Dispose();
        Log(string.Format("> ARWorldMap saved locally to {0}", path));

        storageManager.OnClickUploadARWorldMap();
    }
#endif
